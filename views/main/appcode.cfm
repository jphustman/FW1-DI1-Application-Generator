		...
		<div id="accordion">
			...
			<div>
				<div class="tabs">
					<ul>
						<li>
							<a href="#tabs-appCFC">Application CFC</a>
						</li>
						<li>
							<a href="#tabs-defaultLayout">Default Layout</a>
						</li>
						<li>
							<a href="#tabs-tableSpecific">Table Specific Files</a>
						</li>
					</ul>
					...
					<div id="tabs-tableSpecific">
						<strong>
							Click a table name to view code specific to that table
						</strong>
						<ul>
							<cfloop index="ListElement" list="#rc.tables#">
								<li>
									<cfoutput>
										<a href="#buildURL(action='main.tableSpecificCode', querystring="table=#ListElement#&dsn=#rc.dsn#&siteTitle=#rc.siteTitle#")#">
											#ListElement#
										</a>
									</cfoutput>
								</li>
